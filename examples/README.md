...
- `pinned-image-overlay`: native HTML `<img>` visually pinned to a globe anchor.
...
- `czml-overlay-media`: overlay-based CZML `properties.media_*` media tracking with moving image, native video, and YouTube anchors.
